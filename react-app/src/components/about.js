      ...
      <div className="row">
        <div className="col-md-10 offset-md-1 col-sm-12 about-div">
          ...
          <p className="text-center about-text about-info">
            ...
            great tech companies? Well, <strong>TechCareers NG</strong> is one
            place you can start. We put together the list of the best tech job
            opportunities so you can quickly and easily find jobs in your city
            to apply to. There is always a job form for every area of interests,
            experience level and technology stack.
          </p>
        </div>
      </div>
